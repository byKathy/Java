...
##5. 跨站点请求伪造（csrf）
  ...
  * 为每一个非安全方法添加token，在使用标签的时候，生成token，一般是32位的MD5校验码。例如Spring MVC就可以使用RequestDataValueProcessor这个类结合<form:form>可以生成token。详见<a href=“http://blog.eyallupu.com/2012/04/csrf-defense-in-spring-mvc-31.html”>这里</a>
